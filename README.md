...
* **Weekly Updates:** Large databases (GitHub Advisories, NVD full history), mobile OEM CVE sync, and website scraping (LOTS Project, MalAPI.io).
* **Smart Processing:**
...
| `gftobins_org.json` | Weekly | **Unix**. Binaries for privilege escalation/evasion. | [GTFOBins](https://gtfobins.org/) |
...
| File Name | Freq | Description | Source |
| :--- | :--- | :--- | :--- |
| `epss_scores.csv` | Daily | **EPSS**. Exploit Prediction Scoring System probabilities. | [FIRST.org](https://www.first.org/epss/) |
...
| `mobile/index.json` | Weekly | **Mobile CVE**. Samsung + Pixel + iPhone devices, SPLs/OS versions, and bulletin CVEs (enriched). | mobile-cve-buster |
| `mobile/cves/*.json` | Weekly | **Mobile CVE details**. Per-year CVE detail files for mobile bulletins. | mobile-cve-buster |
...
| `IANA_service_names_port_numbers.csv` | Weekly | **Ports**. IANA Service Name and Port Number Registry. | [IANA](https://www.iana.org/) |
...
* **Threat Intelligence & Malware:**
    * **[Abuse.ch](https://abuse.ch/)** for their comprehensive ecosystem ( ThreatFox, FeodoTracker, URLhaus).
